...
const buttons = [
  { icon: <GooglePlay width={40} height={40} />, label: "Google Play", accessibilityLabel: "Google Play", screen: "GooglePlayScreen" },
  ...
  { icon: <ClubAndAssociations width={40} height={40} />, label: "Clubs & Associations", accessibilityLabel: "Clubs & Associations", screen: "ClubsAssociationsScreen" },
